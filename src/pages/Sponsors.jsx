      ...
      <div className="relative overflow-hidden transition-all duration-500 transform bg-white shadow-lg group rounded-2xl hover:shadow-2xl hover:-translate-y-2">
        ...
        <div className="relative z-10 p-6">
          ...
          <div className="relative mb-6">
            ...
            />
            <div
              className={`absolute -bottom-2 right-4 w-10 h-10 bg-gradient-to-br ${gradientClass} rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
            >
        ...
        {/* Decorative elements */}
        <div
          className={`absolute top-4 right-4 w-16 h-16 ${bgClass} rounded-full group-hover:scale-150 group-hover:bg-white/10 transition-all duration-500`}
        />
      </div>
    );
  };
      ...
      <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="mb-20 text-center">
          ...
          <p className="max-w-3xl mx-auto text-gray-600 text-l">
            We are grateful to our generous sponsors and partners who make our
            Vinayaka Chavithi celebrations possible through their unwavering
        ...
        <div className="p-12 mt-20 text-center text-white bg-gradient-to-r from-blue-600 to-orange-600 rounded-2xl">
          ...
          <p className="mb-8 text-xl opacity-90">
            Join our family of sponsors and help us create unforgettable
            celebrations for our community
          </p>
          <button
